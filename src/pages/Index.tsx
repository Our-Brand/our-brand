...
const Index = () => {
  return <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-background">
      ...
      <div className="absolute bottom-0 right-0 h-[600px] w-[600px] rounded-full bg-accent/30 blur-[120px] animate-pulse-glow" style={{
      animationDelay: "1s"
    }} />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[500px] w-[500px] rounded-full bg-secondary/20 blur-[100px] animate-pulse-glow" style={{
      animationDelay: "2s"
    }} />
      ...
      <main className="relative z-10 flex flex-col items-center justify-center px-4 text-center animate-fade-in">
        ...
        <div className="flex gap-4 items-center">
          ...
          <div className="h-3 w-3 rounded-full bg-primary animate-pulse-glow" style={{
          animationDelay: "0.5s"
        }} />
          <div className="h-1 w-16 rounded-full bg-gradient-brand animate-pulse-glow" />
        </div>
